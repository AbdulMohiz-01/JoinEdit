    ...
    <div className="flex flex-col gap-20 pb-20 bg-black overflow-hidden">
      ...
      <section className="relative pt-20 md:pt-32 pb-16 md:pb-24">
        ...
        <div className="container relative z-10 mx-auto px-4 text-center">
          ...
          {/* Input Form */}
          <div className="mx-auto mb-16 flex max-w-3xl flex-col gap-4 sm:flex-row">
            ...
            <Button size="lg" className="h-14 px-8 bg-white text-black hover:bg-zinc-200 text-base font-bold rounded-xl transition-transform hover:scale-105 active:scale-95 shadow-lg shadow-white/10">
